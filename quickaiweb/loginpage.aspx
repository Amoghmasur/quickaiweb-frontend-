        ...
        <div class="login1">
           <h3 style="padding-left: 150px;"> <b>Welcome Back!</b></h3>
            <p style="padding-left: 100px;">Don't have an account?<a href="http://localhost:49935/signup.aspx">Sign Up Now!</a></p>
                ...
                <br>
                <div class="input-group">
                  <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span><asp:TextBox ID="TextBox2" runat="server" required Width="100%" class="form-control"  placeholder="Password"></asp:TextBox>
                </div>
              <div >
